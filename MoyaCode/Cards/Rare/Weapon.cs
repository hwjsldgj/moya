...
public class Weapon() : MoyaCard(cost: 2,
    ...
    TargetType.Self)
{
    ...
    {
        await PowerCmd.Apply<WeaponPower>(choiceContext, base.Owner.Creature, base.DynamicVars["Power"].BaseValue, base.Owner.Creature, this);
    }
